...
// vafi.js — Duo Vafi (Michal + Kovošrot)
import { VAF } from './vaf.js';

let imprint = 0; // paměť otisků (přibližování)
...
export const VafiLayer = {
  ...
  init() {
    ...
    // interakce → přiblížení Vafi
    window.addEventListener('pointerdown', () => {
      imprint = Math.min(imprint + 1, 20);
      VAF.emit('touch');
    });
