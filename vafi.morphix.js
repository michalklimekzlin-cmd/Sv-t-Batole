...
const DREAMS_KEY = 'vafi_dreams_v1';
...
function makeDNA(){
  ...
  return {
    ...
    genes: {
      palette:  (seed % 5),
      material: (Math.floor(seed/7) % 4),
      eye:      (Math.floor(seed/13)% 3),
      aura:     (Math.floor(seed/17)% 5)
    },
    motifs: {}
  };
}
...
const PALETTES = [
  { base:[0,220,200],  glow:[123,233,255] },
  { base:[120,255,180],glow:[160,255,210] },
  { base:[90,170,255], glow:[150,200,255] },
  { base:[255,170,120],glow:[255,210,180] },
  { base:[200,160,255],glow:[220,190,255] },
];
const MATERIALS = [
